...
export function generateTranscript(messageHistory: Array<TranscriptMessage>){
    ...
    const fileName: string = `./hover_transcript_generator/transcript_outputs/transcript_${formattedDate}.txt`;
    // Create file
    ...
    messageHistory.forEach((msg: TranscriptMessage) => {
        ...
        const line: string = `${msg.author} [${msg.role}] (${msg.dateSent}): ${msg.messageContent}\n`;
